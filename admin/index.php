...
<body class="sticky-header">
	...
	// Some Report Generation Queries
             ...
             if ( isset($_POST["guests"])&&isset($_POST["date"]) && isset($_POST["duration"])){
						$guests=@$_POST['guests'];
						$date=@$_POST['date'];
            ...
            $sql = sprintf("SELECT 1 as res FROM members WHERE company='%s'",
  	                       mysqli_real_escape_string($conn,   $company));
  	        // execute query
  	        $result = mysqli_query($conn,$sql);
            if ($result === false)
    	            die("Could not query database 2");
    	        ...
    	        if (mysqli_num_rows($result) == 1)
    	        {
    	            // remember that user's logged in
      						...
      						$query="INSERT INTO `guest_log`(`company_name`, `guests_num`, `date_in_of10`,`dur_of10`) VALUES ('$company','$guests','$date','$duration');";
      						$res=mysqli_query($conn,$query);
                  if ($result === false)
                        die("Could not query database 3");
                  else {
                    $host = $_SERVER["HTTP_HOST"];
                    $path = rtrim(dirname($_SERVER["PHP_SELF"]), "/\\");
                      die("Success");
                  //  header("Location: http://$host$path/admin/index.php?checkedin=1");
                    exit;
                  }
                  ...
                  <div class="row">
                    <div class="col-md-8">
                      <div class="add-more-member">
                          <a href="javascript:;" class=" ">Hey ! Check in your guest</a>
                    <div class="row">
                    <div class="col-lg-10">
                    <section class="panel">
                    ...
                    <label for="UserName">Guests</label>
                          <input type="number"  name="guests" class="form-control" placeholder="No of guests" required="">
                    </div>
                    <div class="form-group">
                          <label for="date">date of entry</label>
                          <input type="date"  name="date" class="form-control" placeholder="Password" required="">
                    </div>
                    <div class="form-group">
                          <label for="duration">Duration</label>
                          <input type="number"  name="duration" class="form-control" placeholder="Hours" required="">
                    </div>
                    <button type="submit" class="btn btn-info" name="action" value="ADD">Check in</button><br><br>
